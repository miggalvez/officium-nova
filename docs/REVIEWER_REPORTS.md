...
|---|---:|---|---|---|---|---|---|
| `rr-2026-0001` | 2026-04-28 | implemented | accepted | rendering-difference | validation | Maintainer-seeded reviewer pilot verifying that the 1960 Assumption Vespers public DTO preserves the source-backed proper antiphon and keeps it covered by the Phase 5 E2E harness. | `packages/validation/test/reviewer-reports/accepted/rr-2026-0001.json`; `packages/validation/test/e2e-api-harness.test.ts` |
